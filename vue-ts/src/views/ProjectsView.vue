<template>
  <Navbar :title="$t('nav.titleProjects')" :key="$i18n.locale" @darkLightChild="darkLightParent"/>
  ...
  <AndroidPlanningProject v-if="$route.path == '/projects/planning-android'" :updateModeChild="updateMode"/>
